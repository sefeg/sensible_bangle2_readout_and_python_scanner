...
const SETTINGS_FILENAME = 'sensible_settings.json';
const UPDATE_MILLISECONDS = 10;
...
function transmitUpdatedSensorData() {
  ...
  if(isNewBarData) {
    ...
    data_string += "Altitude: " + bar.altitude.toFixed(1) + 'm \n';
    data_string += "Pressure: " + bar.pressure.toFixed(1) + 'mbar \n';
    data_string += "Temperature: " + bar.temperature.toFixed(1) + 'C \n';
  }
  ...
  if(isNewHrmData) {
    ...
    data_string += "BPM: " + hrm.bpm + '\n';
    data_string += "BPM Confidence: " + hrm.confidence + '% \n';
  }
  
  if(isNewAccData){
    data_string += "ACC_x: " + acc.x.toFixed(2) + '\n';
    data_string += "ACC_y: " + acc.y.toFixed(2) + '\n';
    data_string += "ACC_y: " + acc.z.toFixed(2) + '\n';
  }

  if(isNewMagData) {
    data_string += "Heading: " + mag.heading.toFixed(1) + '\n';
  ...
  /*NRF.updateServices({
    0x180D: { // heart_rate
      0x2A37: { // heart_rate_measurement
        notify: true,
        value : [Math.floor(Math.random() * 180)],
      }
    }
  });*/
